        ...
        <div class="col-md-6 col-md-offset-3 login-box">
          ...
          <div class="col-md-10 col-md-offset-1 main-box">
            <div class="user-box">
              ...
              <input class="form-control input-box" type="text" placeholder="" name="admin" value="" required>
            </div>
            <div class="password-box">
              <label class="font">密码</label>
              <br>
              <input class="form-control input-box" type="password" placeholder="" name="password" value=""  required>
            </div>
